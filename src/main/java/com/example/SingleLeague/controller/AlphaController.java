...
import com.example.SingleLeague.util.CodeUtil;
...
public class AlphaController {
    ...
    @ResponseBody
    public String student(@RequestParam(name = "current", required = false, defaultValue = "1") int current,
    ...
    public String setCookie(HttpServletResponse response){
        ...
        // 设置Cookie生效的范围
        cookie.setPath("/SingleLeague/alpha");
        // 设置Cookie的生存时间
